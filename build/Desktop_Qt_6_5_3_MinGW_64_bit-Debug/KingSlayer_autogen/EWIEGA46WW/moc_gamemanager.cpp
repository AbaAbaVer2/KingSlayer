...
static constexpr auto qt_meta_stringdata_CLASSGameManagerENDCLASS = QtMocHelpers::stringData(
    "GameManager",
    "battleLog",
    "",
    "msg",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameManagerENDCLASS_t qt_meta_stringdata_CLASSGameManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 9),  // "battleLog"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 3),  // "msg"
        QT_MOC_LITERAL(27, 14),  // "bossTookDamage"
        QT_MOC_LITERAL(42, 6)   // "damage"
    },
    "GameManager",
    "battleLog",
    "",
...
void GameManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->battleLog((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->bossTookDamage((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameManager::battleLog; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &GameManager::bossTookDamage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameManager::battleLog(QString _t1)
{
...
// SIGNAL 1
void GameManager::bossTookDamage(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
